/* ---- Google Analytics, achter toestemming ----
   ...
   VUL HIER DE MEETCODE IN. Je vindt hem in Google Analytics onder
...
(() => {
  ...
  verwerk(window.vormaToestemming);
  document.addEventListener('vorma:toestemming', (e) => verwerk(e.detail));
})();
